...
function index(props) {
 ...
 let postinfo = post.environment.development.find((ele) => ele.id.toString() === enviId.toString());
          ...
          >
            ...
            >
              ...
              <div className="container mt-10">
                <div className="row">
                  {post.environment.development.map((el) => (
                    <div className=" col-4 " key={el.id}   onClick={()=>{ setEnviId(el.id) ; setShow(true);}}>
                      <Card     className="mb-2 py-5  btn btn-info">
